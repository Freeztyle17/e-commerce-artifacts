...
-  Сотрудник по возвратам авторизован в ТСТ.

**Сценарий:**
1. Сотрудник получает задачу на ТСТ.
...
**Режимы деградации:**
-  Offline‑режим ТСТ – все операции сохраняются локально, синхронизация при восстановлении связи.
